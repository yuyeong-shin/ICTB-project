...
#define MAX_AREA_RADIUS 2550
	...
	typedef enum ODID_authtype {
		...
		// Specific auth method. The exact authentication type is indicated by the
	...
	typedef enum ODID_desctype {
		...
		// Additional clarification when ODID_status != EMERGENCY
		// 3 to 200 reserved
	...
	typedef enum ODID_operator_location_type {
		...
		// Dynamic/Live location and altitude
		ODID_OPERATOR_LOCATION_TYPE_FIXED = 2,
		// Fixed location and altitude
		// 3 to 255 reserved
